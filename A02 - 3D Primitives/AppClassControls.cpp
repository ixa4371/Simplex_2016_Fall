...
void Application::ProcessKeyReleased(sf::Event a_event)
{
	...
	case sf::Keyboard::F4:
		...
		break;
	case sf::Keyboard::F5:
		m_pMesh->GenerateCone(1.0f, 2.0f, 36, C_CYAN);
		break;
	case sf::Keyboard::F6:
		m_pMesh->GenerateCylinder(1.0f, 2.0f, 36, C_CYAN);
		break;
	case sf::Keyboard::F7:
		m_pMesh->GenerateTube(1.0f, 0.7f, 2.0f, 36, C_CYAN);
		break;
	case sf::Keyboard::F8:
		m_pMesh->GenerateSphere(1.0f, 36, C_CYAN);
		break;
	case sf::Keyboard::F9:
		m_pMesh->GenerateTorus(1.0f, 0.6f, 10, 36, C_CYAN);
		break;
