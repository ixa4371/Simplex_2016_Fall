...
class Application
{
	...
	bool showOctree = true; // Used to enable/disable spatial optimization visual representation (turn octree on or off)

private:
	String m_sProgrammer = "Israel Anthony - ixa4371@rit.edu"; //programmer
